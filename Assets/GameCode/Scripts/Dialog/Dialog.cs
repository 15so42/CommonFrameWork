...
using System.Linq;
using _MyGame.Scripts.UiStackSystem;
using DG.Tweening;
using UnityEngine;
...
public class Dialog : UiPanel
{
    ...
    public bool usingTopOrder = true;
    ...
    public static List<Dialog> GetShowingDialogs(string dialogName)
    {
        return dialogs.ToList().FindAll(m => m != null && m.gameObject.name.Contains(dialogName));
    }
